            ...
            <div class="col-12 col-lg-6">
                <div class="contact--info mt-50">
                    ...
                    <ul class="contact-list">
                        <li>
                            <h6><i class="fa fa-clock-o fa-fw" aria-hidden="true"></i> Rekomended Call</h6>
                            <h6>9:00 WIB - 14:00 WIB</h6>
                        </li>
                        <li>
                ...
                <div class="contact--info mt-50 mb-50">
                    ...
                    <form method="POST" action="">
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <textarea class="form-control" name="isi" id="message" cols="30" rows="5"
