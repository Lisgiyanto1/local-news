<div class="clever-main-menu">
    <div class="classy-nav-container breakpoint-off">
        ...
        <nav class="classy-navbar justify-content-between" id="cleverNav">
            ...
            <!-- Logo -->
            <a class="nav-brand" href="/" id="textnav"><img src="{{ asset('img/icons') }}/Logo.png" width="80" alt="">
                Local
                News</a>
            ...
            <div class="classy-menu">
                ...
                <div class="classynav">
                    <ul>
                        <li><a href="/" class="{{ Request::is('/') || Request::is('home') ? 'text-primary' : '' }}">Home</a>
                        </li>
                        ...
                        <li><a href="{{ route('pengumuman') }}" class="{{ Request::segment(1) == 'pengumuman' ? 'text-primary' : '' }}">Pengumuman</a>
                        </li>
